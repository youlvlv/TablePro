...
func (DB2G db2g) charToString(bytes []byte, column *column, conn *DmConnection) string {
	...
	return Dm_build_943.Dm_build_1195(bytes, conn.serverEncoding, conn)
}
...
func (DB2G db2g) toBytes(bytes []byte, column *column, conn *DmConnection) ([]byte, error) {
	retBytes := Dm_build_943.Dm_build_1094(bytes, 0, len(bytes))
...
func (DB2G db2g) toString(bytes []byte, column *column, conn *DmConnection) string {
	...
	case SMALLINT:
		return strconv.FormatInt(int64(Dm_build_943.Dm_build_1167(bytes)), 10)
	case INT:
		return strconv.FormatInt(int64(Dm_build_943.Dm_build_1170(bytes)), 10)
	case BIGINT:
		return strconv.FormatInt(int64(Dm_build_943.Dm_build_1173(bytes)), 10)
	case REAL:
		return strconv.FormatFloat(float64(Dm_build_943.Dm_build_1176(bytes)), 'f', -1, 32)
	case DOUBLE:
		return strconv.FormatFloat(float64(Dm_build_943.Dm_build_1179(bytes)), 'f', -1, 64)
	case DECIMAL:
...
func (DB2G db2g) toBool(bytes []byte, column *column, conn *DmConnection) (bool, error) {
	...
	case SMALLINT:
		return Dm_build_943.Dm_build_1040(bytes, 0) != 0, nil
	case INT:
		return Dm_build_943.Dm_build_1045(bytes, 0) != 0, nil
	case BIGINT:
		return Dm_build_943.Dm_build_1050(bytes, 0) != 0, nil
	case REAL:
		return Dm_build_943.Dm_build_1055(bytes, 0) != 0, nil
	case DOUBLE:
		return Dm_build_943.Dm_build_1059(bytes, 0) != 0, nil
	case DECIMAL:
...
func (DB2G db2g) toUInt16(bytes []byte, column *column, conn *DmConnection) (uint16, error) {
	...
	case SMALLINT:
		return uint16(Dm_build_943.Dm_build_1040(bytes, 0)), nil
	case INT:
		tval := Dm_build_943.Dm_build_1045(bytes, 0)
...
func (DB2G db2g) toInt32(bytes []byte, column *column, conn *DmConnection) (int32, error) {
	...
	case SMALLINT:
		return int32(Dm_build_943.Dm_build_1040(bytes, 0)), nil
	case INT:
...
func (DB2G db2g) toUInt32(bytes []byte, column *column, conn *DmConnection) (uint32, error) {
	...
	case SMALLINT:
		return uint32(Dm_build_943.Dm_build_1040(bytes, 0)), nil
	case INT:
		return uint32(Dm_build_943.Dm_build_1045(bytes, 0)), nil
	case BIGINT:
		tval := Dm_build_943.Dm_build_1050(bytes, 0)
...
func (DB2G db2g) toInt64(bytes []byte, column *column, conn *DmConnection) (int64, error) {
	...
	case SMALLINT:
		return int64(Dm_build_943.Dm_build_1167(bytes)), nil
	case INT:
		return int64(Dm_build_943.Dm_build_1170(bytes)), nil
	case BIGINT:
		return int64(Dm_build_943.Dm_build_1173(bytes)), nil
	case REAL:
		return int64(Dm_build_943.Dm_build_1176(bytes)), nil
	case DOUBLE:
		return int64(Dm_build_943.Dm_build_1179(bytes)), nil
...
func (DB2G db2g) toUInt64(bytes []byte, column *column, conn *DmConnection) (uint64, error) {
	...
	case SMALLINT:
		return uint64(Dm_build_943.Dm_build_1167(bytes)), nil
	case INT:
		return uint64(Dm_build_943.Dm_build_1170(bytes)), nil
	case BIGINT:
		return uint64(Dm_build_943.Dm_build_1173(bytes)), nil
	case REAL:
		return uint64(Dm_build_943.Dm_build_1176(bytes)), nil
	case DOUBLE:
		return uint64(Dm_build_943.Dm_build_1179(bytes)), nil
...
func (DB2G db2g) toFloat32(bytes []byte, column *column, conn *DmConnection) (float32, error) {
	...
	case SMALLINT:
		return float32(Dm_build_943.Dm_build_1040(bytes, 0)), nil
	case INT:
		return float32(Dm_build_943.Dm_build_1045(bytes, 0)), nil
	case BIGINT:
		return float32(Dm_build_943.Dm_build_1050(bytes, 0)), nil
	case REAL:
		return Dm_build_943.Dm_build_1055(bytes, 0), nil
	case DOUBLE:
		dval := Dm_build_943.Dm_build_1059(bytes, 0)
...
func (DB2G db2g) toFloat64(bytes []byte, column *column, conn *DmConnection) (float64, error) {
	...
	case SMALLINT:
		return float64(Dm_build_943.Dm_build_1040(bytes, 0)), nil
	case INT:
		return float64(Dm_build_943.Dm_build_1045(bytes, 0)), nil
	case BIGINT:
		return float64(Dm_build_943.Dm_build_1050(bytes, 0)), nil
	case REAL:
		return float64(Dm_build_943.Dm_build_1055(bytes, 0)), nil
	case DOUBLE:
...
func (DB2G db2g) toDmDecimal(value []byte, column *column, conn *DmConnection) (*DmDecimal, error) {
	...
	case SMALLINT:
		return NewDecimalFromInt64(int64(Dm_build_943.Dm_build_1040(value, 0)))
	case INT:
		return NewDecimalFromInt64(int64(Dm_build_943.Dm_build_1045(value, 0)))
	case BIGINT:
		return NewDecimalFromInt64(Dm_build_943.Dm_build_1050(value, 0))
	case REAL:
		return NewDecimalFromFloat64(float64(Dm_build_943.Dm_build_1055(value, 0)))
	case DOUBLE:
		return NewDecimalFromFloat64(Dm_build_943.Dm_build_1059(value, 0))
	case DECIMAL:
...
func (DB2G db2g) toObject(bytes []byte, column *column, conn *DmConnection) (interface{}, error) {
	...
	case TINYINT:
		...
		return Dm_build_943.Dm_build_1036(bytes, 0), nil
	case SMALLINT:
		return Dm_build_943.Dm_build_1040(bytes, 0), nil
	case INT:
		return Dm_build_943.Dm_build_1045(bytes, 0), nil
